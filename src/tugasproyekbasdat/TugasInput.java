...
import tabel.user.detail.TabelUserDetail;
import tabel.user.detail.UserDetail;

public class TugasInput extends javax.swing.JDialog {

    public TugasInput(java.awt.Frame parent) {
        super(parent);
        initComponents();
    }
    ...
    private void getDatabase() {
        try {         
            ...
            if(jRadioButton1.isSelected()) {
                sql = "SELECT * FROM `barang` WHERE `nama_barang` LIKE '%" + jTextField10.getText() + "%'";
            }
            else if(jRadioButton2.isSelected()) {
                sql = "SELECT * FROM `barang` WHERE `kd_barang` LIKE '%" + jTextField10.getText() + "%'";
            }
            else {
            ...
            while(set.next()) {
                ...
                user.setStockMax(set.getString(5));
                user.setStockMin(set.getString(6));
                user.setPrice(set.getString(4));
                user.setSell(set.getString(3));
                user.setStock(set.getString(8));
                user.setUnit(set.getString(7));
                user.setDiscount(set.getString(9));
                user.setPpn(set.getString(10));
                modelUser.add(user);
            }
        } 
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tugasproyekbasdat.TugasProyekBasdatApp.class).getContext().getResourceMap(TugasInput.class);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kg", "Lt", "Box", "Unt" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Goods Code", "Goods Name", "Stock Max", "Stock Min", "Price", "Sell", "Stock", "Unit", "Discount (%)", "PPn (%)"
            }
        ));
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(tugasproyekbasdat.TugasProyekBasdatApp.class).getContext().getActionMap(TugasInput.class, this);
...
// TODO add your handling code here:
    try{
        ...
        String SQL = "INSERT INTO `barang` (`kd_barang`, `nama_barang`, `HJP`, `HBP`, `min_stock`, `max_stock`, `satuan`, `jmlh_brg`, `diskon`, `ppn`) VALUES ('" + jTextField1.getText() + "','" + jTextField2.getText() + "','" + jTextField6.getText() + "','" + jTextField5.getText() + "','" + jTextField3.getText() + "','" + jTextField4.getText() + "','" + jComboBox1.getSelectedItem() + "','" + jTextField7.getText() + "','" + jTextField8.getText() + "','" + jTextField9.getText() + "')";
