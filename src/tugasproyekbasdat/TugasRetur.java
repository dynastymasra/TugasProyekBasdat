...
public class TugasRetur extends javax.swing.JDialog {

    public TugasRetur(java.awt.Frame parent) {
        super(parent);
        initComponents();
        timeNow = Calendar.getInstance().getTime();
        jDateChooser1.setDate(timeNow);
        timeData();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tugasproyekbasdat.TugasProyekBasdatApp.class).getContext().getResourceMap(TugasRetur.class);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier Code", "Goods Code", "Goods Name", "Supplier Name", "Date", "Total Goods"
            }
        ) {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(tugasproyekbasdat.TugasProyekBasdatApp.class).getContext().getActionMap(TugasRetur.class, this);
    ...
    private void timeData() {
        if(jDateChooser1.getDate() != null) {
            ...
            date = newDate.format(jDateChooser1.getDate());
        }
    }
